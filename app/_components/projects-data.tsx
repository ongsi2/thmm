      ...
      ko: {
        ...
        description: (
          <>
            ...
            {mono('카카오 로그인')} 기반 인증과 한자 뜻풀이·오행 분석 등 한국 작명 문화를 반영했다.
          </>
        ),
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        description: (
          <>
            홈페이지 제작 외주를 받는 스튜디오 사이트이자 내 영업 창구다. 계약 전에{' '}
            {mono('실제 동작하는 시안')}을 먼저 만들어 보여주는 방식으로 일하고, 산후조리원·치과·필라테스·
            법무법인 등 업종별 시안 16건을 갤러리로 공개해 두었다. 그랑베이가 여기서 시작된 첫 사례다.
          </>
        ),
      ...
      ko: {
        ...
        description: (
          <>
            ...
            네트워크가 끊겨도 화면이 멈추지 않는다. 앱인토스 바이브코딩 챌린지 출품작.
          </>
        ),
      ...
      ko: {
        ...
        description: (
          <>
            ...
            저녁·야식) 메뉴를 추천한 뒤 카카오 로컬 API로 근처 식당까지 이어준다. 전 화면 무스크롤 설계.
          </>
        ),
        ctas: [{ label: '토스 앱에서 이용', variant: 'ghost' }],
      },
      ...
      ko: {
        ...
        description: (
          <>
            ...
            서비스다. {mono('Supabase')} 기반 인증과 코인 시스템으로 무료 체험부터 유료 사용까지
            자연스럽게 이어지도록 구성했다.
          </>
        ),
