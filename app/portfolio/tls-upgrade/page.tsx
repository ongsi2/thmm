...
export const metadata: Metadata = {
  ...
  description:
    'WebtoB 공용 SSL 설정을 건드리지 않고 Nginx 계층에서 TLS 종단하는 구조로 전환해, 보안 요구사항을 충족하면서 기존 서비스 영향은 최소화한 케이스 스터디.',
  alternates: { canonical: 'https://thmm.kr/portfolio/tls-upgrade' },
};
...
export default function TlsUpgradeCase() {
  return (
    <main>
      <CaseHero
