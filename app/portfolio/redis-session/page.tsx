...
export const metadata: Metadata = {
  ...
  description:
    'JEUS Standard Edition 라이선스 제약을 Redis 외부 세션 저장소로 우회해, 레거시 환경에서도 무중단 배포 가능한 구조를 구축한 케이스 스터디.',
  alternates: { canonical: 'https://thmm.kr/portfolio/redis-session' },
};
...
export default function RedisSessionCase() {
  return (
    <main>
      <CaseHero
